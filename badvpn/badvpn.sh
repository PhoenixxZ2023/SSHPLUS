...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/PhoenixxZ2023/SSHPLUS/main/ssh-plus)/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/apt install wget -y; bash <(wget -qO- raw.githubusercontent.com/PhoenixxZ2023/SSHPLUS/main/ssh-plus)/main/badvpn/antcrashvpn.sh -o /dev/null
